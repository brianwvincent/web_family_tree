...
const AppStartPage: React.FC<AppStartPageProps> = ({ onImport, onStartManual, onError, error }) => {
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-gray-100 font-sans p-4 py-12">
      <header className="text-center">
        ...
        <p className="mt-2 text-lg text-gray-400 max-w-2xl">
          Bring your family history to life — upload a CSV or GEDCOM file, or build your tree one connection at a time.
        </p>
      </header>
